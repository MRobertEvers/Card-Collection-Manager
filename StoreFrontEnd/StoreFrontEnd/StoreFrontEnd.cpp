...
bool 
StoreFrontEnd::DownloadCardImage( const wxString & aszCardName, const wxString & aszSet, const wxString& aszMud, std::shared_ptr<ImageFetcherCallback> aptCallback )
{
   auto ptse = StoreFrontEnd::Server();
